...
INSERT INTO emergency_call (user_id, call_type, status, description, call_time, created_at) VALUES (2, 'medical', 'completed', '突发心脏病，需要急救', '2026-06-05 14:25:00', '2026-06-05 14:25:00');

INSERT INTO emergency_call (user_id, call_type, status, description, call_time, created_at) VALUES (3, 'security', 'processing', '家中漏水，需要帮助', '2026-06-10 10:00:00', '2026-06-10 10:00:00');
